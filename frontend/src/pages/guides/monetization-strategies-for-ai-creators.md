...
| :--- | :--- | :--- | :--- |
| **Level 1–2 (Starter)** | Students & Solo Devs | ₹199 – ₹499 | Single-task prompts, regex generators, basic debugging assistants. |
| **Level 3 (Pro)** | Mid-Level Engineers | ₹999 – ₹2,499 | Multi-step code refactoring, test suite generators, Docker optimization. |
| **Level 4–5 (Enterprise)** | Teams & Architects | ₹4,999 – ₹14,999+ | Full MCP sidecar integrations, autonomous cloud infrastructure debuggers, security compliance scanners. |

## 2. Writing High-Converting Sales Copy

Your marketplace listing page is your storefront. Focus on clear ROI (Return on Investment) and time saved rather than just technical specs.

### Effective Description Checklist:
- **The Hook**: State exactly how many hours of manual engineering your skill saves (e.g., *"Save 6+ hours of manual Kubernetes log debugging per incident"*).
- **The Problem**: Describe the frustrating manual workflow developers currently endure.
- **The Solution**: Explain how your AI agent automates the task in seconds.
- **Supported Environments**: Clearly list verified compatibility (Cursor, Windsurf, Claude Desktop, VS Code).
